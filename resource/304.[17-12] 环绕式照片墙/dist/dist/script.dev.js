...
.set('.img', {
  ...
  z: -500,
  backgroundImage: function backgroundImage(i) {
    return 'url(https://picsum.photos/id/' + (i + 32) + '/600/400/)';
  },
  backgroundPosition: function backgroundPosition(i) {
    return getBgPos(i);
  },
